...
# go-ripgrep Windows Zip Builder
# Usage: ./scripts/build-zip.sh <arch> [version]
# Example: ./scripts/build-zip.sh amd64 v15.1.0
...
set BINARY_NAME=rg.exe
set INSTALL_DIR=%LOCALAPPDATA%\go-ripgrep
...
echo.
echo Please restart your terminal to use rg.
echo.
echo Run 'rg --help' to get started.
echo ==========================================
pause
EOF
